...
function onCreate()
	...
	makeLuaText('JukeBoxText', 'Artist: PaperKitty', 300, -305-IntroTagWidth, 80)
	...
	makeLuaText('JukeBoxSubText', 'Wocky', 300, -305-IntroTagWidth, 30)
	setTextAlignment('JukeBoxSubText', 'left')
	setObjectCamera('JukeBoxSubText', 'other')
	setTextSize('JukeBoxSubText', IntroSubTextSize)
	addLuaText('JukeBoxSubText')

	--makeLuaText('JukeBoxSubText2', 'Mod: Arcade Showdown', 450, -305-IntroTagWidth, 30)
