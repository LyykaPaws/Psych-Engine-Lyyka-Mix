...
function onCreate()
	...
	makeLuaText('JukeBoxText', 'Artist: HighPoweredKeyz / EthanTheDoodler', 300, -305-IntroTagWidth, 80)
	...
	makeLuaText('JukeBoxSubText', 'Titular (MC Mix)', 300, -305-IntroTagWidth, 30)
	setTextAlignment('JukeBoxSubText', 'left')
	setObjectCamera('JukeBoxSubText', 'other')
	setTextSize('JukeBoxSubText', IntroSubTextSize)
	addLuaText('JukeBoxSubText')

	--makeLuaText('JukeBoxSubText2', 'Mod: DDTO+', 450, -305-IntroTagWidth, 30)
