...
function onCreate()
	...
	makeLuaText('JukeBoxText', 'Artist: Rozebud', 300, -305-IntroTagWidth, 80)
	...
	makeLuaText('JukeBoxSubText2', '[B-Side Remix]', 450, -305-IntroTagWidth, 30)
...
function onTimerCompleted(tag, loops, loopsLeft)
	...
	if tag == 'JukeBoxWait' then
		...
		doTweenX('MoveOutFive', 'JukeBoxSubText2', -550, 1.5, 'CircInOut')
	end
end