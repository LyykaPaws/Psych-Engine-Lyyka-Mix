function onCreate()
	...
	makeLuaSprite('bge', 'stages/week2/bg-evil', 0, 0)
	scaleObject('bge', 2, 2)
	setLuaSpriteScrollFactor('bge', 1, 1)
	addLuaSprite('bge', false)

	makeAnimatedLuaSprite('cabinetse', 'stages/week2/cabinets-evil', 600, 865)
	...
	makeLuaSprite('vigen', 'stages/week2/vignette', 0, 0)
...
--regular--
	makeLuaSprite('bg', 'stages/week2/bg', 0, 0)
	scaleObject('bg', 2, 2)
	setLuaSpriteScrollFactor('bge', 1, 1)
	addLuaSprite('bg', false)

	makeAnimatedLuaSprite('cabinets', 'stages/week2/cabinets', 470, 770)
