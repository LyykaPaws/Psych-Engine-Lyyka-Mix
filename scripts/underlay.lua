...
{
    ['Auto Resize Custom Image Lanes'] = false,
    ['Player Image Base Lanes'] = true,
    ['Player Image Color Lanes'] = true,
    ['Opponent Image Base Lanes'] = true,
    ['Opponent Image Color Lanes'] = true,
    ['Lane Alpha'] = 0.4,
    ['Lane Color Alpha'] = 1,
    ['Auto Duration'] = true,
    ['Fade Time'] = 0.4
