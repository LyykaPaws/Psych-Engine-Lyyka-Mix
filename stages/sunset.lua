function onCreate()
	-- background shit
	makeLuaSprite('stagesunset', 'stages/kapi/stagesunset', -600, -300);
	...
	makeAnimatedLuaSprite('audienceBop','stages/kapi/upperBop',-550,-250)addAnimationByPrefix('audienceBop','dance','Upper Crowd Bob',18,true)
    objectPlayAnimation('audienceBop','dance',false)
    setScrollFactor('audienceBop', 0.9, 0.9);
	
	makeAnimatedLuaSprite('spookyBop','stages/kapi/littleguys',10,100)addAnimationByPrefix('spookyBop','dance','Bottom Level Boppers',25,true)
	objectPlayAnimation('spookyBop','dance',false)
    setScrollFactor('spookyBop', 0.9, 0.9);
	
	makeAnimatedLuaSprite('lightBlink','stages/kapi/lights',-600,-300)addAnimationByPrefix('lightBlink','dance','lightblink',2,true)
