function onCreate()
	-- background shit
	makeLuaSprite('closed', 'stages/kapi/closed', -600, -300);
	...
	makeAnimatedLuaSprite('audienceBop','stages/kapi/upperBop',-550,-250)addAnimationByPrefix('audienceBop','dance','Upper Crowd Bob',24,true)
	...
	makeAnimatedLuaSprite('theFreaks','stages/kapi/bgFreaks',-600,-300)addAnimationByPrefix('theFreaks','dance','Bottom Level Boppers',28,true)
